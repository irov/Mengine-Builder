from PyBuilder.Build import build

from PyBuilder.Arguments.ArgumentInt import ArgumentInt
from PyBuilder.Arguments.ArgumentList import ArgumentList
from PyBuilder.Arguments.ArgumentBool import ArgumentBool
from PyBuilder.Arguments.ArgumentMulti import ArgumentMulti
from PyBuilder.Arguments.ArgumentFloat import ArgumentFloat
from PyBuilder.Arguments.ArgumentString import ArgumentString
...
class PyBuilderConsoleApp(object):
    def __init__(self):
        super(PyBuilderConsoleApp,self).__init__()
        self.arguments = []
