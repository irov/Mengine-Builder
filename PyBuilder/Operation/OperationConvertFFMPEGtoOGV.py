...
class OperationConvertFFMPEGtoOGV(Operation):
    ...
    def _onRun(self):
        ...
        if ToolsBuilderPlugin.convert(self.sourcePath, self.destinationPath, "ffmpegToOGV", dict(ffmpeg=ffmpeg, quality=quality, resize=self.resize)) is False:
