...
from PyBuilder.Config.BaseConfig import BaseConfig
from PyBuilder.Config.IniWriter import IniWriter
...
class ConfigIni(BaseConfig):
    ## NEED FOR INI PARSER
    class PyBuilderMultiLineDictType(dict):
        def __init__(self):
            super(ConfigIni.PyBuilderMultiLineDictType,self).__init__()
            pass
    ...
    def __init__(self):
        ...
        self.config = OptionsSafeConfigParser(None,ConfigIni.PyBuilderMultiLineDictType,strict = False,empty_lines_in_values = False)
        pass
