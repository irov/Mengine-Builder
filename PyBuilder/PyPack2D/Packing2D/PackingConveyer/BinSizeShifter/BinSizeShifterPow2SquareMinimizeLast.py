...
from PyBuilder.PyPack2D.Packing2D.PackingConveyer.BinSizeShifter.BinSizeShifterPow2Square import BinSizeShifterPow2Square,getLowPow2
...
class BinSizeShifterPow2SquareMinimizeLast(BinSizeShifterPow2Square):
    def _onEndToPack(self, result):
        ...
        super(BinSizeShifterPow2SquareMinimizeLast, self)._onEndToPack(result)
