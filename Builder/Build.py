...
def build(jsonConfigContent):
    ...
    project.imageConvertMode = jsonConfigContent.get("img_convert", project.imageConvertMode)
    project.imagePremultiply = jsonConfigContent.get("img_premultiply", project.imagePremultiply)
    project.soundConvertQuality = jsonConfigContent.get("sound_convert_quality", project.soundConvertQuality)
    project.soundConvertMode = jsonConfigContent.get("sound_convert", project.soundConvertMode)
    project.musicConvertQuality = jsonConfigContent.get("music_convert_quality", project.musicConvertQuality)
    project.musicConvertMode = jsonConfigContent.get("music_convert", project.musicConvertMode)
    project.videoConvertQuality = jsonConfigContent.get("video_convert_quality", project.videoConvertQuality)
    project.videoResize = jsonConfigContent.get("video_resize", project.videoResize)
