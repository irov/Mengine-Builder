...
from Builder.Pack2D.Atlas.AtlasImage import AtlasImage
...
class AtlasImageBuilder(AtlasImage):
    def __init__(self, path=None, img=None, onPackCallback=None, onPackCallbackEnd=None):
        super(AtlasImageBuilder, self).__init__(path, img)
...
#        boundY = bound[1] * atlas.height
    ...
    def getImage(self):
        ...
        image = AtlasImageBuilder(path=pathFile, onPackCallback=self._onPackToAtlas, onPackCallbackEnd=self._onPackToAtlasEnd)
