...
from Builder.Constants import BIN_EXTENSION
...
from Builder.Graph.GraphNodeXmlDom import GraphNodeXmlDom
...
class GraphRootXmlDom(GraphRoot):
    ...
    def _createChild(self, path):
        ...
        if FileSystem.getFileExtension(path) == "json":
            from Builder.Graph.GraphRootJson import GraphRootJson
